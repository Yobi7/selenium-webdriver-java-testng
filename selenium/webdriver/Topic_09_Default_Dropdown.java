...
public class Topic_09_Default_Dropdown {
    ...
    public void TC_01_Register() {
        ...
        // Day dropdown
        Select dayDropdpwn = new Select(driver.findElement((By.name("DateOfBirthDay"))));

        //Chọn ngày
        dayDropdpwn.selectByVisibleText(day);

        // Verify dropdown này là Single (k0 phải Multiple)
        Assert.assertFalse(dayDropdpwn.isMultiple());

        // Verify số lượng item trong Dropdown này là 32 item
        List<WebElement> dayOption = dayDropdpwn.getOptions();
