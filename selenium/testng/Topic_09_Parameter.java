...
public class Topic_09_Parameter {
    ...
    private String getEnvironmentUrl(String environmentName) {
        ...
        if (environmentName.equals("dev")) {
            urlName = "http://dev.techpanda.org";
        } else if (environmentName.equals("testing")) {
            urlName = "http://testing.techpanda.org";
        } else if (environmentName.equals("staging")) {
            urlName = "http://staing.techpanda.org";
        } else if (environmentName.equals("live")) {
            urlName = "http://live.techpanda.org";
        } else {
            throw new RuntimeException("Environmant name is not valid.");
        }
        return urlName;
    }
